 ...
 */
let name = "florian"
let nameInCaps = name.capitalized
if (name == nameInCaps) {
...
let lowerCaseNameInCaps = nameInCaps.lowercased()
if (lowerCaseName == lowerCaseNameInCaps) {
    print("\(lowerCaseNameInCaps) and \(lowerCaseName) are the same.")
}
else {
    print("\(lowerCaseNameInCaps) and \(lowerCaseName) are not the same.")
}
// Alternative solution
print("\(lowerCaseNameInCaps) and \(lowerCaseName) are\(lowerCaseName == lowerCaseNameInCaps ? "" : " not") the same.")
