...
let somePlace = GPS(latitutude: 51.514004, longitude: 0.125226)
print(somePlace)
...
var favoriteBook = Book(title: "Creative Selection", author: "Ken Cocienda", pages: 543, price: 12.0)
print(favoriteBook)
...
var myHeight = Height(centimeters: 186)
