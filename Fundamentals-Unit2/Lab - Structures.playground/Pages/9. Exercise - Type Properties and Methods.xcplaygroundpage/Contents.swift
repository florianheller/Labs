 ...
 */
struct User {
    static var currentUser: User = User(userName: "Steve", email: "steve@me.com", age: 78)
    var userName: String
    var email: String
    var age: Int
    ...
    static func logIn(user:User) {
        currentUser = user
        print("User \(user.userName) is now logged in.")
    }
}
 ...
 */
User.logIn(user: User(userName: "Tim", email: "tim@me.com", age: 64))
