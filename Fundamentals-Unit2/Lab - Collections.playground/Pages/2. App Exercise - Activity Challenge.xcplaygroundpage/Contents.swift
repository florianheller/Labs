 ...
 */
let runningChallenges = ["Run 5 times a week", "Run 3 miles", "Run for an hour"]
let walkingChallenges = ["Walk 3 miles a day", "Walk to the grocery store", "Take a walk with your neigbor"]
...
else if finishedChallenges.count == 1 {
    print("The challenge you have chosen is \(finishedChallenges[0])")
}
else {
