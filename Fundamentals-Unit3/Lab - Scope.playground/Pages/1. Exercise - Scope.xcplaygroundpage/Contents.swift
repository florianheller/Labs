...
//print("The value of foo is \(foo)")
// Because foo is declared inside the loop, and is therefore not visible outside
...
// Here, x is defined at global scope, therefore visible within the loop and outside
