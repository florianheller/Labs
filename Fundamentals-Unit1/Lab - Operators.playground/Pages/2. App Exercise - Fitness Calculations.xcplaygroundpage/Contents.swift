...
print("Average Heart Rate as Int \(averageHR)")
...
let addedHeartRateD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHeartRateD / 3.0
print("Average heart rate in Double \(averageHRD)")
...
print("You have achieved \(percentOfGoal * 100)% of your daily goal")
